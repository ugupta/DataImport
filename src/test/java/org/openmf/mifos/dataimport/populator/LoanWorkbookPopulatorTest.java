...
public class LoanWorkbookPopulatorTest {
    ...
    public void shouldPopulateLoanWorkbook() {
        ...
        LoanWorkbookPopulator loanWorkbookPopulator = new LoanWorkbookPopulator(new ClientSheetPopulator(restClient), new PersonnelSheetPopulator(onlyLoanOfficers, restClient),
    	...
    	Assert.assertEquals("Product*", row.getCell(2).getStringCellValue());
    	Assert.assertEquals("Loan Officer*", row.getCell(3).getStringCellValue());
    	Assert.assertEquals("Submitted On*", row.getCell(4).getStringCellValue());
    	Assert.assertEquals("Approved On*", row.getCell(5).getStringCellValue());
    	Assert.assertEquals("Disbursed Date*", row.getCell(6).getStringCellValue());
    	Assert.assertEquals("Payment Type*", row.getCell(7).getStringCellValue());
    	Assert.assertEquals("Fund Name", row.getCell(8).getStringCellValue());
    	Assert.assertEquals("Principal*", row.getCell(9).getStringCellValue());
    	Assert.assertEquals("# of Repayments*", row.getCell(10).getStringCellValue());
    	Assert.assertEquals("Repaid Every*", row.getCell(11).getStringCellValue());
    	Assert.assertEquals("Loan Term*", row.getCell(13).getStringCellValue());
    	Assert.assertEquals("Nominal Interest %*", row.getCell(15).getStringCellValue());
    	Assert.assertEquals("Amortization*", row.getCell(17).getStringCellValue());
    	Assert.assertEquals("Interest Method*", row.getCell(18).getStringCellValue());
    	Assert.assertEquals("Interest Calculation Period*", row.getCell(19).getStringCellValue());
    	Assert.assertEquals("Arrears Tolerance", row.getCell(20).getStringCellValue());
    	Assert.assertEquals("Repayment Strategy*", row.getCell(21).getStringCellValue());
    	Assert.assertEquals("Grace-Principal Payment", row.getCell(22).getStringCellValue());
    	Assert.assertEquals("Grace-Interest Payment", row.getCell(23).getStringCellValue());
    	Assert.assertEquals("Interest-Free Period(s)", row.getCell(24).getStringCellValue());
    	Assert.assertEquals("Interest Charged From", row.getCell(25).getStringCellValue());
    	Assert.assertEquals("First Repayment On", row.getCell(26).getStringCellValue());
    	Assert.assertEquals("Amount Repaid", row.getCell(27).getStringCellValue());
    	Assert.assertEquals("Date-Last Repayment", row.getCell(28).getStringCellValue());
    	Assert.assertEquals("Repayment Type", row.getCell(29).getStringCellValue());
